defmodule ApporteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ApporteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ApporteWeb.Gettext, "errors", msg, opts)
    end
  end
