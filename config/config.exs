...
config :apporte, ApporteWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: ApporteWeb.ErrorHTML, json: ApporteWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Apporte.PubSub,
...
config :apporte, Apporte.Mailer, adapter: Swoosh.Adapters.Local
...
config :apporte, ApporteWeb.Auth.Guardian,
  issuer: "apporte",
  secret_key: "+Dk0RjCbKxetLhvOD1CQjY02pgvCgzzy22WXYi2Cwtk3iXEngBWGmTo0RbsNH/v+"

config :apporte, ApporteWeb.Plug.AuthAccessPipeline,
  module: ApporteWeb.Auth.Guardian,
  error_handler: ApporteWeb.Auth.AuthErrorHandler
